...
public class CatalogUtilities {
    ...
    public static void load(Catalog catalog, String file) throws IOException, ClassNotFoundException {
        FileInputStream fileIn = new FileInputStream(System.getProperty("user.dir") + "/catalogues/" + file);
